...
//    ppfPath is the path to the the PPF (Persistent Pointer Factory), it
...
// i.e. when umlRun=1.
// ----------------------------------------------------------------------
Generator::Generator(MainParameters *mp,char **argv){
    int i,k;
    ...
    i=mp->ppfPath;
    if(i==0)ppfPath="c:\\ppf\\factory.h";
    else    ppfPath=argv[i+1];
...
int main(int argc,char **argv){
    int err,i,numOpt,numArg,paramStart; char *tmpLibPath;
    ...
    Generator generator(mp,&(argv[paramStart]));
